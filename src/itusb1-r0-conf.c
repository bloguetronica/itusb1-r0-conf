/* ITUSB1 Rev. 0 Configuration Program - Version 1.0 for Debian Linux
...
int main(int argc, char **argv)
{
    ...
    {
        fprintf(stderr, "Error: Missing argument.\nUsage: itusb1-r0-conf SERIALNUMBER\n");
...
{
    unsigned char control_buf_out[64] = {
        0x30, 0x03, 0x49, 0x00, 0x54, 0x00, 0x55, 0x00,  // ITUSB1 USB Test Switch
...
{
    unsigned char control_buf_out[64] = {
        0x1C, 0x03, 0x49, 0x00, 0x55, 0x00, 0x31, 0x00,  // IU1-00xxxxxx
...
void write_usb_cfg(libusb_device_handle *devhandle)  // Writes the USB configuration values into the OTP ROM
{
    unsigned char control_buf_out[10] = {
        ...
        0x23,        // Maximum power is 70mA (0x23)
